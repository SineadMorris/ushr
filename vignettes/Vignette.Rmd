...
If you encounter any bugs related to this package please contact the package author directly. Additional descriptions of the model and analysis performed by this package are available in [Morris et al. (2020) BMC Bioinformatics](https://rdcu.be/b1yZU). Further details on the mathematical theory can also be found in the references cited below. <!--Package documentation is also available from CRAN-->
